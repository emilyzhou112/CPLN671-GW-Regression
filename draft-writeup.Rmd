...
The results from the heteroscedasticity tests align with the pattern observed in the scatter plot of standardized residuals versus fitted values. 
...
In the plot, the spread of residuals appears to increase with changes in fitted values, suggesting a violation of the constant variance assumption, known as heteroscedasticity. This visual evidence is consistent with the findings from the Breusch-Pagan, Koenker-Bassett, and White tests, all of which indicated significant heteroscedasticity in the model. Together, these results confirm that the model's residuals exhibit non-constant variance, suggesting the need for adjustments to obtain reliable estimates.
