...
regData <- st_read(here("CPLN671-GW-Regression-main", "data", "RegressionData.shp"))
...
bw <- readRDS(here("CPLN671-GW-Regression-main", "data", "bandwidth_gwr.rds"))
gwrmodel <- readRDS(here("CPLN671-GW-Regression-main", "data", "gwrmodel.rds"))
gwrmodel
```
