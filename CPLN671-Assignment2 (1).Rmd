...
The results of the regression analysis between the standardized residuals (Standardized_Residuals) and their nearest neighbor residuals (Residuals_NB) indicate a significant spatial autocorrelation. The coefficient for Residuals_NB is 0.7323, with a highly significant p-value, demonstrating a strong positive relationship. This implies that residuals are positively correlated with those of their closest neighbors, confirming spatial dependence.
